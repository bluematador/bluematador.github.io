...
This endpoint retrieves Blue Matador events from an account that were opened within a time period
...
`GET https://api.bluematador.com/ma/api/accounts/<account_id>/events/active`
